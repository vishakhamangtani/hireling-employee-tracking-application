...
public class table_A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelperFinal = new DBHelperFinal4(table_A.this);
        System.out.println(userId);
        Cursor c = dbHelperFinal.displayA();
        t1=(TableLayout) findViewById(R.id.tableA);
        t1.setColumnStretchable(0,true);
        t1.setColumnStretchable(1,true);
        t1.setColumnStretchable(2,true);
        t1.setColumnStretchable(3,true);
        TableRow tr = new TableRow(table_A.this);
        TextView head1=new TextView(table_A.this);
        TextView head2=new TextView(table_A.this);
        TextView head3=new TextView(table_A.this);
        TextView head4=new TextView(table_A.this);
        ...
        t1.addView(tr);
        while (c.moveToNext()) {
            TextView id1 = new TextView(table_A.this);
            TextView name1 = new TextView(table_A.this);
            TextView date1 = new TextView(table_A.this);
            TextView action = new TextView(table_A.this);
            TableRow ts = new TableRow(table_A.this);
